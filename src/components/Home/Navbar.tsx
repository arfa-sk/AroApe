      ...
      <div className=" mx-auto p-5 sm:p-12 flex justify-between items-center text-white">
        <Link to="/">
          <div className="logo overflow-hidden flex">
            <div
              className={`name-logo relative left-0 text-3xl text-[${logoColor}] flex items-baseline`}
            >
              <span className="font-[600] tracking-tighter" style={{ fontFamily: "'Poppins', sans-serif", letterSpacing: "-0.05em" }}>aro</span>
              <span className="italic ml-2 font-normal" style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.15em", letterSpacing: "0.01em" }}>ape</span>
            </div>
            <svg
              viewBox="0 0 64 66"
              fill="none"
        ...
        <div className="links overflow-hidden hidden sm:flex items-center gap-10">
          <div className="sm:flex items-center gap-5">
            ...
            <Link to={"https://www.linkedin.com/in/arfa-khan24/"} target="blank">
              <FaLinkedin
                style={{
                  color: logoColor,
                }}
